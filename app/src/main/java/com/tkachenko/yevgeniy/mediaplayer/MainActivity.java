...
public class MainActivity extends AppCompatActivity implements SeekBar.OnSeekBarChangeListener {
    ...
    public static final String Broadcast_PLAY_NEW_AUDIO = "com.yevgeniy.tkachenko.mediaplayer.PlayNewAudio";
    public static final String BROADCAST_SEEK_TO = "com.yevgeniy.tkachenko.mediaplayer.SeekTo";
    public static final String BROADCAST_APP_CONTROLS = "com.yevgeniy.tkachenko.mediaplayer.AppControls";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.nowPlayed = (TextView)findViewById(R.id.played_song);
        ...
        this.playPauseButton = (Button)findViewById(R.id.button_pause_play);
